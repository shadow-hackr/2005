...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : SANAM TASEER
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : REAL AFTHZ
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : MAFIA320
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SARA X SHADOW] : %s/%s -> \033[0;92m [ txt-OK:%s ]- \033[0;91m[txt-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		exit(" [*] GitHub    : https://github.com/Mafia320/old2")
	else:
		Main()
